...
class Die {
    ...
    /*
    *side: explicit heap-dynamic
    * value: explicit heap-dynamic
    * MIN_SIDES: stack
    * DEFAULT_SIDES: stack
    * INIT_VALUE: stack
    * sides: stack
    * this.sides: heap-dynamic
     */
    private int sides;
    private int value;
    ...
    public static void main(String[] args) {
        //Stack dynamic implicit heap-dynamic  implicit heap-dynamic    implicit heap-dynamic
